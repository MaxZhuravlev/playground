 ...
 *
 * Leaf определяет поведение элементов комбинации. ДЖля этого он реализует операции, поддерживаемые интерфейсом Composite.
 */
...
class Composite extends AComponent
{
    ...
    public function createIterator()
    {
        return new ConcreteIterator2($this->components);
    }
}
...
class ConcreteIterator2 implements IIterator
{
    /**
