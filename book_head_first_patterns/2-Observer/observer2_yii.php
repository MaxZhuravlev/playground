...
class Observer {
    ...
    public function stopObservingWeather($subject){
         ...
         */
        echo "<br/> Detach observer handler method update: ".$subject->detachEventHandler('onMeasurementsChanged',array($this, 'update'));
        echo "<br/> Detach observer handler method update2: ".$subject->detachEventHandler('onMeasurementsChanged',array($this, 'update2'));
...
class WeatherStation{
    function __construct(){
        ...
        $currentDisplay = new Observer();
        $currentDisplay->observeWeather($weatherData);
        //$statisticsDisplay = new StatisticsDisplay($weatherData);
        //$forecastDisplay = new ForecastDisplay($weatherData);
        $weatherData->setMeasurements(10,20,10);
        $currentDisplay->stopObservingWeather($weatherData);
